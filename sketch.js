...
function setup() {
    ...
    ball1 = Bodies.circle(300,600,25,ball_options);
	World.add(world,ball1);

	ball2 = Bodies.circle(270,600,25,ball_options);
	World.add(world,ball2);

	ball3 = Bodies.circle(300,600,20,ball_options);
	World.add(world,ball3);

	ball4 = Bodies.circle(300,600,20,ball_options);
	World.add(world,ball4);

	ball5 = Bodies.circle(300,600,20,ball_options);
...
function keyPressed() {
	if (keyCode === UP_ARROW) {
	  Matter.Body.applyForce(ball1,{x : 3,y : 0},{x : -0.1,y : 0});
	}
  }
